...
//            }
//        }
//        System.out.println("Poriniai " + count);
//
//        System.out.println("...............................");
...
//        int count9 = 0;
//        int count91 = 0;
//        for (int i = 0; i < plants9.length; i++) {
//            System.out.println(plants9[i].length());
//            if (plants9[i].length() < 5) {
//                count9++;
//            }
//            if (plants9[i].length() > 7) {
//                count91++;
//            }
//        }
//
...
//        int count10 = 0;
//        for (int i = 0; i < plants9.length; i++) {
//            if (plants9[i].length() > 5 && plants9[i].length() < 10) {
//                count10++;
//            }
//        }
//        System.out.println("From 5 to 10 letters: " + count10);
//
//        System.out.println("...........................");
//
...
//            for (int i = 0; i <25 ; i++) {  //vidinis ciklas rodo atvaizdavima x asimi.
//                    System.out.print("* ");
//            }
...
//        }
        ...
        int min = 10;
        int max = 20;
        int taskaiPetras = min + (int) Math.round(Math.random() * (max - min));
        int min2 = 5;
        int max2 = 25;
        int taskaiKazys = min + (int) Math.round(Math.random() * (max - min));
        ...
        int sumKazys = 0;
        while (true){
            int taskaiPetras2 = min + (int) Math.round(Math.random() * (max - min));
            int taskaiKazys2 = min + (int) Math.round(Math.random() * (max - min));
            if (taskaiPetras2 >=0){
